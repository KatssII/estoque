...
$tabela = $pdo->prepare("SELECT * FROM prodU WHERE id_prodU=:prodU;");
$tabela->execute(array(':prodU' => $prodU));
...
<head>
    ...
    <title>Cadastro de Produto Único</title>
...
<body style="background-color: #F0F2F0;">
    <div class="container">
        ...
        <br>
        <form action="CRUD/update_prodU.php" method="post" id="formulario" action="editar">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="tabela_prdoU.php" type="button" class="btn btn-outline-info float-end">Esoque Produto Único</a>
                    </div>
                </div>
            </div>
            <input type="hidden" name="id_prodU" value="<?php echo $rowTable[0]['id_prodU']; ?>">
        </form>
