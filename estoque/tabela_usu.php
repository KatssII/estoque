...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-faded" style="background-color: #FADDD7; border-color: #000;">
            <a class="navbar-brand" href="tabela_usu.php">Usuários Cadastrados</a>
        ...
        <?php
            ...
            foreach ($rowTabela as $linha){
                ...
                echo '<td><a href=edit_tabelaUsu.php?usuario='.$linha['id_usuario'].' class="btn btn-outline-warning">Editar</a></td>';
                echo '<td><a href="CRUD\delete_usu.php?usuario='.$linha['id_usuario'].'" class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
