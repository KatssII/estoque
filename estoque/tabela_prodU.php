...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-faded" style="background-color: #FADDD7; border-color: #000;">
            <a class="navbar-brand" href="tabela_entrada.php">Estoque Geral</a>
        ...
        <!--Barra de pesquisa-->
        <br>
        <h2 style="text-align:center;">Estoque Produtos Únicos</h2>
        <br>
        ...
        <div class="container">
            ...
            <table class="table table-striped">
                ...
                <?php
                    foreach ($rowTabela as $linha){
                        ...
                        echo '<td><a href=edit_tabelaProdU.php?item='.$linha['id_item'].' class="btn btn-outline-warning">✎</a></td>';
            ...
            <a href="index_prodU.php" class="btn btn-outline-info">CADASTRAR NOVO ITEM</a>
        </div>
        ...
        <script>
            ...
            function searchData()
            {
                window.location = 'tabela_prodU.php?search='+search.value;
            }
        </script>
    </body>
</html>